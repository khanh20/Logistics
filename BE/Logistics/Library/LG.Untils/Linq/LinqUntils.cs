using LG.Utils.Linq.Const;
using System.Globalization;
using System.Linq.Expressions;

namespace LG.Untils.Linq
{
    public static class LinqUtils
    {
        ...
        /// <param name="sort"></param>
        /// <returns></returns>
        public static IQueryable<TEntity> WhenMany<TEntity>(this IQueryable<TEntity> query, IList<Expression<Func<TEntity, bool>>>? predicates) where TEntity : class
        {
