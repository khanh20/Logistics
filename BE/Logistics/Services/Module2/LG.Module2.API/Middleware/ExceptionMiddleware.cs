    ...
    IHostEnvironment env)
{
    ...
    private async Task HandleAsync(HttpContext ctx, Exception ex)
    {
        var (status, code, message) = ex switch
        {
            ...
            DuplicateCustomsClearanceException e => (409, e.Code, e.Message),
            FeeAlreadyPaidException e            => (409, e.Code, e.Message),
            InvalidWebhookSignatureException e  => (401, e.Code, e.Message),
            ...
            PackageNotWeighedException e        => (422, e.Code, e.Message),
            FeeNotCalculatedException e         => (422, e.Code, e.Message),
            EmptyDeliveryRequestException e     => (422, e.Code, e.Message),
