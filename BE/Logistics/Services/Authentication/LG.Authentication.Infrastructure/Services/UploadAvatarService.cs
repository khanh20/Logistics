...
namespace LG.Authentication.Infrastructure.Services;
...
public class UploadAvatarService : IUploadAvatar
{
    private readonly Cloudinary _cloudinary;
    private readonly ILogger<UploadAvatarService> _logger;

    public UploadAvatarService(IConfiguration config, ILogger<UploadAvatarService> logger)
    {
        _logger = logger;
